...
namespace Homework_7
{
    public partial class Form1 : Form
    {
        ...
        Pen p2 = new Pen(Brushes.Pink);
        Pen p3 = new Pen(Brushes.DarkRed);
        Pen p4 = new Pen(Brushes.DarkKhaki);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            g3.DrawRectangle(new Pen(Color.LightGray, 1), 0, 0, pictureBox3.Width - 1, pictureBox3.Height - 1);
